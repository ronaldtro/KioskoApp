    ...
    return (
        <div className="shadow p-5 mb-3 flex gap-10 items-center">
            ...
            <div>
                ...
                <button onClick={() => handleEliminarProducto(producto.id)} type='button' className="bg-red-700 flex gap-2 px-5 py-2 text-white rounded-md font-bold uppercase shadow-md w-full mt-5">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
