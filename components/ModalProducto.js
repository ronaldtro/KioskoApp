...
const ModalProducto = () => {
    ...
    const [precio, setPrecio] = useState(formatearDinero(producto.precio))
    ...
    useEffect(() => {
        setPrecio(formatearDinero(producto.precio*cantidad))
    }, [cantidad])
    ...
    return (
        <div className="md:flex gap-10 ">
            ...
            <div className="md:w-2/3">
                ...
                <button onClick={() => handleAgregarPedido({ ...producto, cantidad })} type='button' className="bg-indigo-600 hover:bg-indigo-800 px-5 py-2 mt-5 text-white font-bold uppercase rounded" >
